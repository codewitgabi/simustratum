...
const REASSURANCES = [
  "Reset links are tied to your verified email",
  "Links expire after a short window for safety",
  "Your sessions, scores, and progress stay untouched",
];

function ForgotPasswordSidebar() {
      ...
      <div className="my-auto flex flex-col gap-8 py-16">
        <div>
          ...
          <h2 className="mb-4 font-grotesk text-[2.6rem] leading-[1.06] font-bold tracking-[-1.5px] text-white">
            ...
            happens to
            <br />
            <span className="text-camel">everyone.</span>
          </h2>
